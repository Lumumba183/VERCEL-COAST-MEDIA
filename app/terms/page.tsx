...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      updated="August 2026"
      sections={[
        { heading: '1. Acceptance of Terms', body: 'By accessing The News Booth website, radio streams and TV content, you agree to these Terms of Service and all applicable laws of the Republic of Kenya. If you do not agree, please do not use our services.' },
        { heading: '2. Content & Copyright', body: 'All articles, audio, video and graphics published by The News Booth are protected by copyright. You may share links and short excerpts with attribution; reproduction of full content requires written permission.' },
        ...
        { heading: '6. Liability', body: 'News content is provided in good faith; while we strive for accuracy, The News Booth is not liable for decisions made based on published content. Corrections are published promptly when errors are identified.' },
