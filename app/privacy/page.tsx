  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: '3. Story Source Protection', body: 'The News Booth protects the identity of confidential news sources in line with Kenyan media law and our editorial code. Tell us if you wish to remain anonymous when submitting a story.' },
        ...
        { heading: '5. Your Rights', body: 'You may request access to, correction of, or deletion of your personal data at any time by emailing info.newsbooth@gmail.com. We respond to all requests within 30 days.' },
        { heading: '6. Contact', body: 'Questions about this policy? Contact The News Booth, Nairobi, Kenya — phone +254 750 777 777 or email info.newsbooth@gmail.com.' },
      ]}
    />
  );
}
