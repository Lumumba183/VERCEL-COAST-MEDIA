...
export default function PlayerBar() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 bg-newsbooth-navy text-white shadow-2xl border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
        <span className="w-9 h-9 rounded-lg bg-newsbooth-red flex items-center justify-center shrink-0">
          <Radio size={18} />
        </span>
        <div className="min-w-0">
          <p className="text-sm font-bold truncate">Live Radio — Live</p>
        ...
        <button
          onClick={toggle}
          className="ml-auto w-10 h-10 rounded-full bg-newsbooth-red flex items-center justify-center hover:brightness-110 transition shrink-0"
